...
const Navigation = () => {
  ...
  return (
    <>
      <nav className="border-b border-black dark:border-elite h-28 mx-[4vw] max-w-[1024px] w-full pb-4 relative flex justify-between items-end">
        <button
          onClick={() => setOpen(true)}
          className="h-12 w-12 flex flex-col justify-center items-center"
        >
          <span className="block rounded-2xl w-5 -translate-y-1 h-0.5 bg-black" />
          <span className="block rounded-2xl w-5 translate-y-0 h-0.5 bg-black" />
          <span className="block rounded-2xl w-5 translate-y-1 h-0.5 bg-black" />
        </button>
